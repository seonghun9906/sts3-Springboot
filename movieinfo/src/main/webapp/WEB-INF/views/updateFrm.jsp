		...
		<div class="content">
			<form action="updateProc" method="post" enctype="multipart/form-data">
				...
				<input type="text" class="write-input" value="${movie.m_name}"
					name="m_name" autofocus placeholder="제목" required> <input
					type="text" class="write-input" value="${movie.m_director}"
					name="m_director" placeholder="감독" required> <input
					type="text" class="write-input" value="${movie.m_nation}"
					name="m_nation" placeholder="국가" required> <input
					type="text" class="write-input" value="${movie.m_genre}"
					name="m_genre" placeholder="장르" required> <input
					type="text" class="write-input" value="${movie.m_actor}"
					name="m_actor" placeholder="주연배우" required> <input
					type="text" class="write-input" value="${movie.m_open}"
					name="m_open" placeholder="개봉일" required>
